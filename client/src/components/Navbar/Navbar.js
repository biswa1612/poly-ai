...
import { getMySnippets } from '../../actions/snippets';
    ...
    return(
        <AppBar className={classes.appBar} position="static" color="inherit">
            <Link to="/" className={classes.brandContainer}>
                <Typography className={classes.heading}>PasteHere</Typography>
            </Link>
            <Toolbar className={classes.toolbar}>
                {user ? (
                    <div className={classes.profile}>
                        <Link to='/pastehere/mySnippets' >
                            <Typography onClick={handleClick}>My Snippets</Typography>
                        </Link>
